# 🌸 PriBLOOM – **Pri**mordial **B**lack hole **L**ensing **O**ptical depth with **O**bservations from **M**onitoring surveys

This repository contains code to compute and visualize the gravitational lensing optical depth and dark matter constraint for primordial black holes (PBHs), using cosmological models and FRB-like time delay constraints. We use the Bustling Universe Radio Survey Telescope in Taiwan (BURSTT) in this repository as an example.
